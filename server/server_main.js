...
/* App Variables */
const main = express();
const port = process.env.BACKENDPORT || '3999';
...
main.get('/profiles/:profileId', (req, res) => {
...
// Request parameters: profile ID
main.get('/statistics/:profileId', (req, res) => {
  if(!req.params.profileId) res.status(400).end();
...
// Request parameters: profile ID
main.get('/strangers/:profileId', (req, res) => {
  if(!req.params.profileId) res.status(400).end();
...
main.get('/faces/profiles/:filename', (req, res) => {
...
// Request parameters: name of the image file
main.get('/faces/strangers/:filename', (req, res) => {
  if(!req.params.filename) res.status(400).end();
...
main.post('/faces/:folder', [], (req, res) => {
...
main.post('/sendemail', function(req, res){
...
main.post('/sendsms', function(req, res){
...
// Request parameters: 
// Request body: object describing a Profile { profileId, firstName, lastName, phone, email, system, family, notifications, notificationsPhone, notificationsEmail }
main.put('/profiles/:profileId', (req, res) => {
...
// Request parameters: profile ID
// Request body: object describing a ProfileStatistics { profileId*, faces, unrecognized }
main.put('/statistics/:profileId', (req, res) => {
  if(!req.params.profileId || !req.body) res.status(400).end();
...
main.delete(`/faces/:filename`, (req, res) => {
  if(!req.params.filename) res.status(400).end();
...
// Request parameters: profile ID
main.delete(`/profiles/:profileId`, (req, res) => {
  if(!req.params.profileId) res.status(400).end();
...
// Request parameters: profile ID
main.delete(`/statistics/:profileId`, (req, res) => {
  if(!req.params.profileId) res.status(400).end();
...
// Request parameters: profile ID
main.delete(`/strangers/:profileId`, (req, res) => {
  if(!req.params.profileId) res.status(400).end();
